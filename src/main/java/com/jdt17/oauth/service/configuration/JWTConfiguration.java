...
public class JWTConfiguration {
    ...
    public JwtEncoder jwtEncoder() throws GeneralSecurityException, IOException {
        ...
        RSAPrivateKey privateKey = loadPrivateKey("certs/private-key.pem");
        RSAPublicKey publicKey = loadPublicKey("certs/public-key.pem");
    ...
    /**
     * Load and parse RSA private key from a PEM file in the resources folder.
     *
